				...
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						<Col xs={12} md={12} lg={8} xxl={8}>
							<h1>SXSW Punks!</h1>
							<p className='sub-header'>Availble on 05 / 01 / 22</p>
						</Col>
					...
					<Row className='flex m-3'>
						...
						<Col md={5} lg={4} xl={5} xxl={4}>
							...
							<p className='text'>
								Mint unique NFTs inspired by the colorful people of the SXSW Festival in Austin, Texas!
							</p>
						...
						<Col md={5} lg={4} xl={5} xxl={4}>
							{isError ? (
								...
								<div>
									...
									<ul>
										<li>25 custom generated punked out images using an art generator</li>
